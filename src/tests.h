...
void T_arrive_train(FILE *fin) {
    ...
    for (int i = -2; i < 102; i++) arrive_train(station, i, 1);
    for (int i = 102; i < -1; i--) arrive_train(station, i, 2);
    show_existing_trains(station, fin);
...
void T_leave_train(FILE *fin) {
    ...
    for (int i = -2; i < 102; i++) leave_train(station, i);
    show_existing_trains(station, fin);

    for (int i = 0; i < 100; i++) arrive_train(station, i, 1);
    for (int i = 0; i < 100; i+=2) leave_train(station, i);
    show_existing_trains(station, fin);

    close_train_station(station);
}

void T_add_train_car(FILE *fin) {
    TrainStation *station = open_train_station(5);
    ...
    for (int i = 0; i < 100; i++) add_train_car(station, 0, 17);
    show_existing_trains(station, fin);

    for (int i = 0; i < 100; i++) add_train_car(station, 2, 19), add_train_car(station, 4, 23);
    show_existing_trains(station, fin);

    close_train_station(station);
}

void T_remove_train_cars(FILE *fin) {
    ...
    for (int i = -2; i < 10; i++) remove_train_cars(station, i, 1), remove_train_cars(station, i, 2);
    show_existing_trains(station, fin);
...
void T_move_train_cars(FILE *fin) {
    ...
    for (int i = 1; i <= 10; i++)
        add_train_car(station, 2, i), add_train_car(station, 0, i);
    show_existing_trains(station, fin);
    ...
    for (int i = 0; i < 10; i++) arrive_train(station, i, 100);
    ...
    for (int i = 0; i < 10; i++) leave_train(station, i);
    show_existing_trains(station, fin);

    close_train_station(station);
}

void T_find_express_train(FILE *fin) {
    ...
    for (int i = 0; i < 10; i++) arrive_train(station, i, i*10);
...
void T_find_overload_train(FILE *fin) {
    TrainStation *station = open_train_station(10);
...
void T_find_optimal_train(FILE *fin) {
    TrainStation *station = open_train_station(10);

    for (int i = 0; i < 10; i++) arrive_train(station, i, 100-i);
...
void T_find_heaviest_sequence_train(FILE *fin) {
    TrainCar *car = NULL;
    TrainStation *station = open_train_station(10);

    for (int i = 0; i < 10; i++) arrive_train(station, i, 1000);
    ...
    for (int i = 0; i < 10; i++) remove_train_cars(station, i, 1);
...
void T_fix_overload_train(FILE *fin) {
    TrainStation *station = open_train_station(4);

    for (int i = 0; i < 4; i++) arrive_train(station, i, 10);
